...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Engine::*)()>(_a, &Engine::captureStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Engine::*)()>(_a, &Engine::captureStopped, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Engine::*)(QString )>(_a, &Engine::engineError, 2))
            return;
    }
}
...
// SIGNAL 0
void Engine::captureStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Engine::captureStopped()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Engine::engineError(QString _t1)
{
