...
void AudioMixer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->levelsUpdated((*reinterpret_cast<std::add_pointer_t<QList<float>>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioMixer::*)(QVector<float> )>(_a, &AudioMixer::levelsUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void AudioMixer::levelsUpdated(QVector<float> _t1)
{
