...
void PluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pluginFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PluginManager::*)(const QString & )>(_a, &PluginManager::pluginLoaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (PluginManager::*)(const QString & , const QString & )>(_a, &PluginManager::pluginFailed, 1))
            return;
    }
}
...
// SIGNAL 1
void PluginManager::pluginFailed(const QString & _t1, const QString & _t2)
{
